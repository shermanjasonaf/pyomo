...
def construct_master_feasibility_problem(model_data, config):
    ...
    #   (polished) master solution from previous iteration
...
def solve_master(model_data, config):
    ...
    if model_data.iteration > 0:
        feas_results = solve_master_feasibility_problem(model_data, config)
        master_soln.feasibility_problem_results = feas_results
