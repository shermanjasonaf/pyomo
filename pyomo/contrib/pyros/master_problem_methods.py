...
def create_dr_polishing_problem_lps(model_data, config):
    """
    ...
    for idx, (dr_eq, indexed_polishing_var, ss_var, inf_var) in enumerate(dr_eq_var_zip):
        ...
        for term_idx, dr_eq_term in enumerate(dr_expr_terms):
            ...
            # Conditions under which to fix DR variable:
...
def minimize_dr_vars_lps(model_data, config):
    ...
    polishing_successful : bool
        ...
        False otherwise.
    """
    polishing_model = create_dr_polishing_problem_lps(model_data, config)
...
def create_dr_polishing_problem_nlp(model_data, config):
    """
...
def minimize_dr_vars_nlp(model_data, config):
    ...
    polishing_successful : bool
        ...
        False otherwise.
    """
    polishing_model = create_dr_polishing_problem_nlp(model_data, config)
